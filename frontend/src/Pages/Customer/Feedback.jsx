        ...
        <ThemeProvider theme={defaultTheme}>
            <div className={classes.root}>
                ...
                <section className={classes.feedbackList}>
                            ...
                            <List>
                                {feedbacks.map((feedback) => (
                                    <React.Fragment key={feedback.id}>
                                        <ListItem>
                                            <ListItemText
                                                primary={feedback.propertyId.name}
                                            />
                                        </ListItem>
                    ...
                    <Grid item xs={3}> 
                        <span style={{ fontSize: '16px', fontWeight: 'bold' }}>Avg Rating: </span>
                        <span style={{ fontSize: '16px', fontWeight: 'bold' }}>{((feedback.rating + feedback.rating2 + feedback.rating3) / 3).toFixed(1)}</span>
                    </Grid>
                </Grid>
